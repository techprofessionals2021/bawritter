      ...
      <form autocomplete="off" class="form-horizontal" method="post" action="{{ route('update_my_profile') }}">
         ...
         <div class="form-row">
            <div class="form-group col-md-6">
               ...
               <input type="text" class=" text-grey form-control form-control-sm {{ showErrorClass($errors, 'first_name') }}" name="first_name" value="{{ old('first_name', $user->first_name) }}">
            ...
            <div class="form-group col-md-6">
               ...
               <input type="text" class=" text-grey form-control form-control-sm {{ showErrorClass($errors, 'last_name') }}" name="last_name" value="{{ old('last_name', $user->last_name) }}">
               <div class="invalid-feedback d-block">
         ...
         <div class="form-group">
            ...
            <textarea class="text-grey form-control form-control-sm {{ showErrorClass($errors, 'bio') }}" name="bio">{{ old('bio', optional($user->meta)->bio) }}</textarea>
            <div class="invalid-feedback d-block">
         ...
         <div class="form-group">
            ...
            <textarea class="text-grey form-control form-control-sm {{ showErrorClass($errors, 'address') }}" name="address">{{ old('address', optional($user->meta)->address) }}</textarea>
            <div class="invalid-feedback d-block">
         ...
         <div class="form-group">
            <label class="sky">Preferred method for receiving payment <span class="required">*</span></label>
            <input type="text" class=" text-grey form-control form-control-sm {{ showErrorClass($errors, 'preferred_payment_method') }}" name="preferred_payment_method" value="{{ old('preferred_payment_method', optional($user->meta)->preferred_payment_method ) }}" placeholder="example: paypal">
            <div class="invalid-feedback d-block">
               {{ showError($errors, 'preferred_payment_method') }}
            </div>
         </div>
         <div class="form-group">
            <label class="sky">Payment method details <span class="required">*</span></label>
            <input type="text" class="text-grey form-control form-control-sm {{ showErrorClass($errors, 'payment_method_details') }}" name="payment_method_details" value="{{ old('payment_method_details', optional($user->meta)->payment_method_details ) }}">
            <div class="invalid-feedback d-block">
         ...
         <div class="form-group">
            ...
            <?php echo form_dropdown("timezone", $data['timezones'], old('timezone', $user->timezone ), "class='text-grey form-control form-control-sm  selectpicker'") ?>
            <div class="invalid-feedback d-block">
