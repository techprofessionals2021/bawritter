...
<section class="pt-5 pt-lg-0">
   <div class="container">
      <div class="row">
         <div class="col-lg-4">
            <div class="sticky-top d-none d-sm-block" data-toggle="sticky" data-sticky-offset="30" data-negative-margin=".card-profile-cover">
               <div class="card card-profile br-20 shadow ">
                  <div class="card-profile-cover">
                     <img alt="Image placeholder" src="{{ $photo_url }}" class="card-img-top user-avatar" >
                  </div>
                  {{-- <a href="#" class="mx-auto">
                  <img alt="Image placeholder" src="{{ $photo_url }}" class="mt-10 card-profile-image avatar rounded-circle shadow hover-shadow-lg user-avatar">
                  </a> --}}
                  <div class="card-body p-3 pt-0 text-center mt-10 sky">
                     <h5 class="mb-0 sky font-weight-bold">{{ $user->full_name }}</h5>
