<div class="card order-box shadow bg-white rounded">
   ...
   <div class="row order-overview">
      ...
      <div class="col-md-6"><span class="font-weight-bold">Admin Assigned To</span>
         <br>
         <?php
   ...
   <div class="row order-overview">
      ...
      <div class="col-md-6"><span class="font-weight-bold">Client Assigned To</span>
        ...
        <?php
           ...
           {
              echo '<a href="'.route('user_profile', $order->staff_id_from_client).'">'.$order->assignee_from_client->full_name.'</a>';
           }
           ?>
     </div>
