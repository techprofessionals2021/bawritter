...
<form role="form" class="form-horizontal card-body shadow br-20" enctype="multipart/form-data"
   ...
   <div class="form-group">
      <label class="sky">Price Type<span class="required">*</span></label>
   ...
   <div class="form-row"
      ...
      <div class="form-group col-md-6">
         <label class="sky">Single Spacing Price <span class="required">*</span></label>
         <input type="text"
      ...
      <div class="form-group col-md-6">
         <label class="sky">Double Spacing Price <span class="required">*</span></label>
         <input type="text"
   ...
   <div class="form-group"
      ...
      <label class="sky">Minimum Order Quantity <span class="required">*</span></label>
      <input type="text"
   ...
   <div class="form-group">
      <label class="sky">Additional Services</label>
   ...
   <div class="form-group">
      <div class="custom-control custom-checkbox">
         <input type="checkbox" class="custom-control-input text-grey" id="inactive" name="inactive" value="1"
