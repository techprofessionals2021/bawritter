...
@include('setup.partials.action_toolbar', [
 ...
 <form role="form" class="form-horizontal  card-body shadow br-20" enctype="multipart/form-data" action="{{ (isset($urgency->id)) ? route( 'urgencies_update', $urgency->id) : route('urgencies_store') }}" method="post" autocomplete="off" >
   {{ csrf_field()  }}
   @if(isset($urgency->id))
   {{ method_field('PATCH') }}
   @endif
   <div class="form-row">
      <div class="form-group col-md-6">
         <label class="sky">Duration and Type <span class="required">*</span></label>
         <div class="input-group mb-3">
            <input type="text" class=" text-grey form-control" name="value" value="{{ old_set('value', NULL, $urgency) }}" placeholder="Example : 3">
