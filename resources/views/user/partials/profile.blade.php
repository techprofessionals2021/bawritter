<div class="card shadow br-20">
   <div class="card-body">
      <h5 class="card-title sky font-weight-bold">About</h5>
      ...
      <div class="pt-5 mt-5 delimiter-top">
         ...
         <div class="pt-5 mt-5 delimiter-top">
            <!-- Title -->
            <h6 class="mb-4 sky">Feedback from clients (Most recent 5) <a href="{{ route('user_profile', $user->id) }}?group=ratings">See All</a></h6>
